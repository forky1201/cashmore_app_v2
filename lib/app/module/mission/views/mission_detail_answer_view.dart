...
class MissionDetailAnswerView extends GetView<MissionDetailController> {
  const MissionDetailAnswerView({super.key});
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if(answer == controller.missionAnswer1.value){
                          // 정답 제출 처리 로직
        ...
        if (controller.isLoading.value) {
          ...
          return Column(
            children: [
                ...
                return Column(
                  children: [
                    CommonMissionHeader(
                      ...
                      path: "assets/images/mission_item_1.png",
                    ),
                    const Divider(
                      color: Colors.grey,
                      thickness: 0.5,
              ...
              const SizedBox(height: 16),
              Obx(() {
                return controller.missionKeyword.value.isNotEmpty
                    ? Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 16.0),
                        child: Row(
                          children: [
