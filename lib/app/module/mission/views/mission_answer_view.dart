...
class MissionAnswerView extends GetView<MissionController> {
  const MissionAnswerView({super.key});
          ...
          Expanded(
            child: Obx(() {
              return RefreshIndicator(
                onRefresh: () async {
                  await controller.refreshMissions(); // 새로고침 호출
                },
                child: controller.isLoadingMissions.value && controller.missions.isEmpty
                    ...
                    : controller.missions.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemCount: controller.missions.length + 1, // 로딩 인디케이터를 위해 +1
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                onTap: () {
                                  ...
                                  if(mission.quest_type == "2"){
                                    controller.moveToUrlAnswer("/mission_answer", mission.quest_number);
                                  }else if(mission.quest_type == "3"){
                                    controller.moveToUrlAnswer("/mission_share", mission.quest_number);
                                  }
                                  
                                },
                                child: _buildMissionListItem(
                                  mission.quest_type == "2" ? "정답 퀘스트" : "공유 퀘스트",
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // 아이콘
          Image.asset(
            'assets/images/mission_item_1.png', // PNG 파일 경로
            width: 48, // 적절한 크기 설정
            height: 48,
